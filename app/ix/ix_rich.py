...
@summary: whoosh index for rich notes
@author: YangHaitao
'''
...
class IX(object):
    ...
    def index_all_rich_by_num_flag(self, item_num, key = "", db_flag = None, db_rich = None, merge = False):
        result = False
        try:
            ...
            if flag == True:
                ...
                if flag_time != False and flag_time != None:
                    ...
                    if flag == True:
                        notes_iter = db_rich.get_rich_by_flag_iter(flag_time)
    ...
    def index_all_rich_by_num(self, item_num, key = "", db_rich = None, merge = False):
        result = False
        try:
            notes_iter = db_rich.get_rich_from_db_iter()
            flag = update_whoosh_index_doc_num(self.ix,
                                               notes_iter,
                                               item_num,
                                               self.name,
    ...
    def index_all_rich_by_num_user(self, item_num, user_name, key = "", db_rich = None, merge = False):
        result = False
        try:
            notes_iter = db_rich.get_rich_from_db_by_user_iter(user_name)
            flag = update_whoosh_index_doc_num(self.ix,
                                               notes_iter,
                                               item_num,
                                               self.name,
    ...
    def index_rich_by_id(self, doc_id, user_name, key = "", db_rich = None, merge = False):
        result = False
        try:
    ...
    def index_delete_rich_by_id(self, doc_id, merge = False):
        result = False
        try:
    ...
    def index_delete_rich_by_user(self, item_num, user_name, merge = False):
        result = False
        try:
